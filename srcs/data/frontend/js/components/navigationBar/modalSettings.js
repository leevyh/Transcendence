...
async function createSettingsForm() {
    ...
    settingsForm.addEventListener('submit', async (event) => {
        ...
        // ATTENTION, si le nickname est vide et qu'on veut changer que l'email, le nickname sera vide 
        ...
        if (nickname.length < 3 || nickname.length > 10) {
            ...
            errorMessage.textContent = 'Nickname must be between 3 and 10 caracters';
